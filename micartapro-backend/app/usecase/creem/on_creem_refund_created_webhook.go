...
type OnCreemRefundCreatedWebhook func(ctx context.Context, input events.CreemRefundCreatedWebhook) error

func init() {
	ioc.Register(NewOnCreemRefundCreatedWebhook)
}

func NewOnCreemRefundCreatedWebhook(
	obs observability.Observability,
	saveBillingEvent supabaserepo.SaveBillingEvent) OnCreemRefundCreatedWebhook {
	return func(ctx context.Context, input events.CreemRefundCreatedWebhook) error {
		spanCtx, span := obs.Tracer.Start(ctx, "on_creem_refund_created_webhook")
		defer span.End()
