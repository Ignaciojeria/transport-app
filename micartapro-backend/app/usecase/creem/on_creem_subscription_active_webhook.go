...
type OnCreemSubscriptionActiveWebhook func(ctx context.Context, input events.CreemSubscriptionActiveWebhook) error

func init() {
	ioc.Registry(NewOnCreemSubscriptionActiveWebhook,
		observability.NewObservability,
		supabaserepo.NewSaveBillingEvent)
}

func NewOnCreemSubscriptionActiveWebhook(
	obs observability.Observability,
	saveBillingEvent supabaserepo.SaveBillingEvent) OnCreemSubscriptionActiveWebhook {
	return func(ctx context.Context, input events.CreemSubscriptionActiveWebhook) error {
		spanCtx, span := obs.Tracer.Start(ctx, "on_creem_subscription_active_webhook")
		defer span.End()
