...
type OnCreemSubscriptionExpiredWebhook func(ctx context.Context, input events.CreemSubscriptionExpiredWebhook) error

func init() {
	ioc.Registry(NewOnCreemSubscriptionExpiredWebhook,
		observability.NewObservability,
		supabaserepo.NewSaveBillingEvent)
}

func NewOnCreemSubscriptionExpiredWebhook(
	obs observability.Observability,
	saveBillingEvent supabaserepo.SaveBillingEvent) OnCreemSubscriptionExpiredWebhook {
	return func(ctx context.Context, input events.CreemSubscriptionExpiredWebhook) error {
		spanCtx, span := obs.Tracer.Start(ctx, "on_creem_subscription_expired_webhook")
		defer span.End()
