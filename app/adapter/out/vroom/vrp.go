...
type Optimize func(ctx context.Context, request request.OptimizationRequest) (domain.Plan, error)
...
func NewOptimize(
	...
	return func(ctx context.Context, req request.OptimizationRequest) (domain.Plan, error) {
