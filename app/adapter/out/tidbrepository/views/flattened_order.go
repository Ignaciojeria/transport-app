	...
	return domain.Order{
		...
		Origin: domain.NodeInfo{
			...
			AddressInfo: domain.AddressInfo{
				...
				State:    domain.State(o.OriginState),
				Province: domain.Province(o.OriginProvince),
				//	Locality:     o.OriginLocality,
				District: domain.District(o.OriginDistrict),
		...
		Destination: domain.NodeInfo{
			...
			AddressInfo: domain.AddressInfo{
				...
				State:    domain.State(o.DestinationState),
				Province: domain.Province(o.DestinationProvince),
				//	Locality:     o.DestinationLocality,
				District: domain.District(o.DestinationDistrict),
