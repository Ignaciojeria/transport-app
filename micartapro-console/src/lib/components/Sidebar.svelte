...
>
  ...
  <nav class="px-4 py-4 flex-1 overflow-y-auto min-h-0">
    <button
      onclick={() => onSectionChange('negocios')}
    ...
    >
      ...
      <span class="text-sm font-medium">{t.sidebar.negocios ?? 'Negocios'}</span>
    </button>
    ...
    <button
      onclick={() => onSectionChange('jornada')}
      class={`w-full flex items-center p-3 rounded-lg transition-all duration-200 mb-2 ${
    ...
    >
      ...
      <span class="text-sm font-medium">{t.sidebar.jornada}</span>
    </button>
    ...
    >
      ...
      <span class="text-sm font-medium">{t.sidebar.reportes}</span>
    </button>

    <button
      onclick={() => onSectionChange('cost')}
      class={`w-full flex items-center p-3 rounded-lg transition-all duration-200 mb-2 ${
        activeSection === 'cost' 
          ? 'bg-blue-600 text-white shadow-md' 
          : 'text-gray-300 hover:bg-gray-800 hover:text-white'
    ...
    >
      ...
      <span class="text-sm font-medium">{t.sidebar.cost}</span>
    </button>
